...
updated: 2024-02-01 20:48:08-08:00
---
...
If you already blog with [Nikola](../../../card/Nikola.md) or [Pelican](https://getpelican.com), you are all set. Those site generators natively support reStructuredText.

[Hugo](../../../card/Hugo.md) will build `.rst` content if you have `rst2html.py` installed.
...
Although RST is readable, more folks are familiar with [Markdown](../../../card/Markdown.md). I know I was more familiar with Markdown when I started this. Once you get the hang of it, you may find that RST has its charms.
